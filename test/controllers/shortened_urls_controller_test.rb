...
class ShortenedUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shortened_url" do
    assert_difference("ShortenedUrl.count") do
      post shortened_urls_url, params: { shortened_url: { original_url: @shortened_url.original_url, short_url: @shortened_url.short_url, user_id: @shortened_url.user_id } }
    end
  ...
  test "should update shortened_url" do
    patch shortened_url_url(@shortened_url), params: { shortened_url: { original_url: @shortened_url.original_url, short_url: @shortened_url.short_url, user_id: @shortened_url.user_id } }
